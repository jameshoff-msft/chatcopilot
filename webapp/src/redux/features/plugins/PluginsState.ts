...
import addPlugin from '../../../assets/plugin-icons/add-plugin.png';
...
export const initialState: PluginsState = {
    plugins: {
        [BuiltInPlugins.RFP]: {
            name: BuiltInPlugins.RFP,
            publisher: 'Microsoft',
            description: 'Ask questions to the RFP Document Database',
            enabled: false,
            authRequirements: {},
            headerTag: AuthHeaderTags.RFP,
            icon: addPlugin,
        },
